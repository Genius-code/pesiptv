...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#FFFFFF"></path>
                ...
                <h3 class="pricing-title">IPFOX</h3>
            </div>
            <ul class="pricing-feature-list">
                <li class="pricing-feature">3500 CHANNEL</li>
                <li class="pricing-feature">Support 24/7</li>
                <li class="pricing-feature">Support All Devices</li>
            </ul>
...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#FFFFFF"></path>
                ...
                <h3 class="pricing-title">NOVA</h3>
            </div>
            <ul class="pricing-feature-list">
                <li class="pricing-feature">3500 CHANNEL</li>
                <li class="pricing-feature">Support 24/7</li>
...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#FFFFFF"></path>
                ...
                <h3 class="pricing-title">COBRA</h3>
            </div>
            <ul class="pricing-feature-list">
                <li class="pricing-feature">20000 CHANNEL</li>
                <li class="pricing-feature">Support 24/7</li>
                <li class="pricing-feature">Support All Devices</li>
            </ul>
            <button class="pricing-action">Choose plan</button>
...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#FFFFFF"></path>
                ...
                <h3 class="pricing-title">BLUE</h3>
            </div>
            <ul class="pricing-feature-list">
                <li class="pricing-feature">19000 CHANNEL</li>
                <li class="pricing-feature">Support 24/7</li>
                <li class="pricing-feature">Support All Devices</li>
            </ul>
            <button class="pricing-action">Choose plan</button>
